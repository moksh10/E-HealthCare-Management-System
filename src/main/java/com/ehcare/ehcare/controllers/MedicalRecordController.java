...
public class MedicalRecordController {
	...
	public ResponseEntity<ResponseSuccess> getMedicalRecordsByDate(@PathVariable("date") @DateTimeFormat(pattern = "dd/MM/yyyy") Date date)
	{
	...
	public ResponseEntity<ResponseSuccess> saveMedicalRecord(@PathVariable int doctorID,@Valid @RequestBody MedicalRecord medicalRecord,HttpServletRequest request)
	{
	...
	@PutMapping
	public ResponseEntity<ResponseSuccess> updateMedicalRecord(HttpServletRequest request,@Valid @RequestBody MedicalRecord medicalRecord)
	{
		int medicalRecordID=(int)request.getAttribute("medicalRecordID");
		medicalRecord.setMedicalRecordID(medicalRecordID);
		MedicalRecord updatedMedicalRecord=medicalRecordService.updateMedicalRecord(medicalRecord.getMedicalRecordID(), medicalRecord);
		return new ResponseEntity<>(new ResponseSuccess("MedicalRecord updated",true,updatedMedicalRecord),HttpStatus.OK);
